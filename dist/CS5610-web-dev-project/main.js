...
var ExperienceListComponent = /** @class */ (function () {
    ...
    ExperienceListComponent.prototype.check = function () {
        console.log(this.ongoingStatus);
    };
...
/*!***********************************************************************************!*\
  !*** ./src/app/components/job-seeker-dashboard/job-seeker-dashboard.component.ts ***!
  \***********************************************************************************/
/*! exports provided: JobSeekerDashboardComponent, SearchFilterPipe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var NavBarComponent = /** @class */ (function () {
    function NavBarComponent(userService, router) {
        ...
        this.userService = userService;
        this.router = router;
        this.router.events.subscribe(function () { return _this.sessionCheck(); });
    }
...
var RecruiterDashboardComponent = /** @class */ (function () {
    function RecruiterDashboardComponent() {
    }
...
var ViewJobComponent = /** @class */ (function () {
    function ViewJobComponent(jobService, route, saveJobService) {
        var _this = this;
    ...
    ViewJobComponent.prototype.saveJobId = function (id) {
    };
    ...
    ViewJobComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_job_listing_service__WEBPACK_IMPORTED_MODULE_3__["JobListingService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"],
            _services_save_job_service__WEBPACK_IMPORTED_MODULE_4__["SaveJobService"]])
    ], ViewJobComponent);
...
module.exports = __webpack_require__(/*! F:\Project\commit-integrate-frontend\job-portal\src\main.ts */"./src/main.ts");
